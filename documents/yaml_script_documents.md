...
| qwit_tool              | `/SFTP.conf.pe.02/V6ENV/Quectel_Write_IMEI_OFFLINE_V1.8_For_VeriFone` | Công cụ ghi imei vào sản phẩm.                                                                                     |
...
|                                                 | `mes.GET_VARIABLES_CHECK_JSON`              | `~`                                                                                                                                                                                                                                                                                                  | `PASS` `FAIL`  | - API mes cung cấp lấy giá trị 1 biến.                                                                                                                                                                    | Chế độ OFFLINE sẽ lỗi.                                                                                                                                                                                                                                                                |
|                                                 | `mes.SAVE_VARIABLE_IGNORE_NON_SETTING_JSON` | `~`                                                                                                                                                                                                                                                                                                  | `PASS` `FAIL`  | - API mes cung cấp đặt giá trị cho 1 biến.                                                                                                                                                                | Chế độ OFFLINE sẽ lỗi.                                                                                                                                                                                                                                                                |
...
|                                                 | `mes.GET_IMEI_FROM_SNO_CODE`                | `~`                                                                                                                                                                                                                                                                                                  | `PASS` `FAIL`  | Lấy một IMEI mới từ MES và lưu vào `context` với tên `MES[imei]`                                                                                                                                          | Chế độ OFFLINE sẽ lỗi. Dành cho các trạm cần ghi IMEI mới lấy từ MES.                                                                                                                                                                                                                 |
...
|                                                 | `dialog.show_with_auto_close`               | - `title: <tiêu đề>` <br> - `message: <nội dung>` <br> - `timeout: <thời gian hiển thị>`                                                                                                                                                                                                             | `true`         | Hiển thị một hộp thoại thông báo và chờ xác nhận OK, sẽ tự thoát sau thời gian timeout.                                                                                                                   |                                                                                                                                                                                                                                                                                       |
...
|                                                 | `func.read_value`                           | - `source: <nguồn>` <br> - `expect: <chuỗi mong đợi>` <br> - `match_index: <index của chỗi match cần lấy>` <br> - `replace: <chuỗi cần thay thế>` <br> `replace_with: <giá trị thay thế>`  <br> - `convert: <to_lower, to_upper>` <br>  - `var_name: <tên biến lưu giá trị>`                                                                 | `true` `false` | Đọc một giá trị từ log nhận được và lưu vào `context`.                                                                                                                                                    | - Trả về `false` nếu không tìm thấy. <br> - `expect`: dùng chuỗi string hoặc `re_<expression>` để khớp với một biểu thức chính quy. <br> - `index`: vị trí nhóm cần lấy <br> - `replace`: dùng trực tiếp regex <br> - `replace_with`: dùng chuỗi string <br>                          |
...
|                                                 | `func.cm5_picture_measure`                  | - `lower_limit: <giá trị dưới>`   <br> - `upper_limit: <giá trị trên>` <br> - `picture_name: <tên ảnh>` <br> - `golden_sample_folder_path: <đường dẫn đến thư mục GOLDEN SAMPLE>`                                                                                                                    | `true` `false` | Tính MSE ảnh cho trạm CM5 CAMERA                                                                                                                                                                          | - `picture_name` lấy tên ảnh và định dạng, ví dụ `FRONT_LIGHT_ON.jpg`                                                                                                                                                                                                                 |
|                                                 | `func.generate_imei2_from_imei1`            | - `imei1: <giá trị imei1>`                                                                                                                                                                                                                                                                           | `true`         | Tính giá trị imei2 từ imei1 (2 imei sẽ liên tiếp nhau) và lưu vào `context["PROD[imei2]"]`                                                                                                                | - `imei1` phải là imei 15 ký tự.                                                                                                                                                                                                                                                      |
|                                                 | `func.check_com_device_exist`               | - `com_name: <tên cổng com>`                                                                                                                                                                                                                                                                         | `true` `false` | Kiểm tra xem có cổng com xuất hiện không. Cho UX300. Kiểm tra cổng com dạng `USB Serial Device` trên device manager                                                                                       |
...
| `qwit` - tool Quectel_Write_IMEI_OFFLINE_V1.8.1 | `qwit.AUTO`                                 | - `working_path: <đường dẫn thư mục chứa chương trình>` <br> - `exe_name: <tên chương trình>` <br> - `imei: <imei ghi vào (độ dài là 15)>`                                                                                                                                                           | `PASS` `FAIL`  | Sử dụng tool `Quectel_Write_IMEI_OFFLINE_V1.8.1.exe` ghi imei vào sản phẩm.                                                                                                                               | - Config để tự tải tool xuống. <br> - trước khi chạy tool sản phẩm cần được vào chế độ AT trước. Để giá trị mặc định `exe_name: Quectel_Write_IMEI_OFFLINE_V1.8.1.exe`                                                                                                                |
